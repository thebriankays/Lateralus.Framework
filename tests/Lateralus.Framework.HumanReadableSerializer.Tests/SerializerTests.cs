...
namespace Lateralus.Framework.HumanReadable.Tests;
...
#pragma warning restore CS1998
    ...
    [Fact]
    public void Type() => AssertSerialization(typeof(SerializerTests), "Lateralus.Framework.HumanReadable.Tests.SerializerTests, Lateralus.Framework.HumanReadableSerializer.Tests");

    [Fact]
    public void Type_Covariant_Contravariant() => AssertSerialization(typeof(ICovariantContravariantInterface<,>), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+ICovariantContravariantInterface<in T1, out T2>, Lateralus.Framework.HumanReadableSerializer.Tests");
    ...
    [Fact]
    public void Type_AnonymType() => AssertSerialization(new { }.GetType(), "<>f__AnonymousType4, Lateralus.Framework.HumanReadableSerializer.Tests");

    [Fact]
    public void MethodInfo() => AssertSerialization(typeof(object).GetMethod("ToString"), "System.Object.ToString()");

    [Fact]
    public void MethodInfo_dynamic_Parameter() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.Dynamic)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.Dynamic(dynamic value)");

    [Fact]
    public void MethodInfo_dynamic_ValueTuple_Parameter() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.ValueTupleDynamic)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.ValueTupleDynamic((dynamic, System.Int32) value)");
    
    [Fact]
    public void MethodInfo_dynamic_Nested_ValueTuple_Parameter() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.ValueTupleNestedDynamic)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.ValueTupleNestedDynamic((dynamic A, (System.Int32 B, dynamic C) D) value)");

    [Fact]
    public void MethodInfo_ValueTuple_Parameter() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.NotNamed)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.NotNamed((System.Int32, System.String) a)");

    [Fact]
    public void MethodInfo_ValueTuple_Named_Parameter() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.Named)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.Named((System.Int32 A, System.String B) a)");

    [Fact]
    public void MethodInfo_ValueTuple_Named_ReturnType() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.NamedResult)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.NamedResult()");

    [Fact]
    public void PropertyInfo_ValueTuple_Named_ReturnType() => AssertSerialization(typeof(Methods).GetProperty(nameof(Methods.NamedProperty)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.NamedProperty");
    ...
    [Fact]
    public void MethodInfo_Generic() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.GenericMethod)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.GenericMethod<TEnum>(System.String value)");

    [Fact]
    public void MethodInfo_Generic_Constructed() => AssertSerialization(typeof(Methods).GetMethod(nameof(Methods.GenericMethod)).MakeGenericMethod(typeof(DayOfWeek)), "Lateralus.Framework.HumanReadable.Tests.SerializerTests+Methods.GenericMethod<System.DayOfWeek>(System.String value)");
    ...
    [Fact]
    public void ConstructorInfo_Static() => AssertSerialization(typeof(ClassWithStaticCtor).GetConstructors(BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)[0], "static Lateralus.Framework.HumanReadable.Tests.SerializerTests+ClassWithStaticCtor()");
