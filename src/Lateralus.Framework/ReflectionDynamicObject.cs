...
public sealed class ReflectionDynamicObject : DynamicObject
{
    ...
    public override bool TryGetMember(GetMemberBinder binder, out object? result) => TryGetMemberValue(binder.Name, out result);

    public override bool TrySetMember(SetMemberBinder binder, object? value) => TrySetMemberValue(binder.Name, value);
