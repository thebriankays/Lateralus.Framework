...
{
    public static string ToHexaString(this byte[] bytes) => ToHexaString(bytes, default);

    public static string ToHexaString(this byte[] bytes, HexaOptions options) => ToHexaString(bytes.AsSpan(), options);

    public static string ToHexaString(this ReadOnlySpan<byte> bytes) => ToHexaString(bytes, default);
