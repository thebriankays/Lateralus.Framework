namespace Lateralus.Framework.Threading;
...
public sealed class AsyncLock
{
    ...
    public ValueTask<AsyncLockObject> LockAsync() => LockAsync(CancellationToken.None);
    ...
    private sealed class WaiterCompletionSource : TaskCompletionSource<AsyncLockObject>
    {
        ...
        private static TaskCreationOptions GetOptions(bool allowInliningContinuations) => allowInliningContinuations ? TaskCreationOptions.None : TaskCreationOptions.RunContinuationsAsynchronously;
    }
}
