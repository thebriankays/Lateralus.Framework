    ...
    where TKey : notnull
{
    ...
    private static bool KeyEqual(TKey item1, TKey item2) => EqualityComparer<TKey>.Default.Equals(item1, item2);

    public List<KeyValuePair<TKey, TValue>>.Enumerator GetEnumerator() => _items.GetEnumerator();
