...
public static class EnumerableExtensions
{
...
#endif
    public static IEnumerable<T> Sort<T>(this IEnumerable<T> list) => Sort(list, comparer: null);
    ...
    public static long LongIndexOf<T>(this IEnumerable<T> list, T value) where T : IEquatable<T> => list.LongIndexOf(value, EqualityComparer<T>.Default);
    ...
    /// </summary>
    public static IEnumerable<T> AsEnumerableOnce<T>(this IEnumerable<T> enumerable) => new EnumerableOnce<T>(enumerable);
    ...
    public static Task ParallelForEachAsync<TSource>(this IEnumerable<TSource> source, Func<TSource, Task> action) => ParallelForEachAsync(source, action, CancellationToken.None);

    public static Task ParallelForEachAsync<TSource>(this IEnumerable<TSource> source, Func<TSource, Task> action, CancellationToken cancellationToken) => ParallelForEachAsync(source, Environment.ProcessorCount, action, cancellationToken);

    public static Task ParallelForEachAsync<TSource>(this IEnumerable<TSource> source, int degreeOfParallelism, Func<TSource, Task> action) => ParallelForEachAsync(source, degreeOfParallelism, action, CancellationToken.None);
