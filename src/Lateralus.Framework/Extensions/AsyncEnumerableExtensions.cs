...
public static class AsyncEnumerableExtensions
{
    ...
    public static ValueTask<bool> ContainsAsync<T>(this IAsyncEnumerable<T> enumerable, T value, CancellationToken cancellationToken = default) => ContainsAsync(enumerable, value, comparer: null, cancellationToken);
    ...
    public static IAsyncEnumerable<T> DistinctAsync<T>(this IAsyncEnumerable<T> enumerable, CancellationToken cancellationToken = default) => DistinctAsync(enumerable, comparer: null, cancellationToken);
    ...
    public static IAsyncEnumerable<T> DistinctByAsync<T, TKey>(this IAsyncEnumerable<T> enumerable, Func<T, TKey> getKey, CancellationToken cancellationToken = default) => DistinctByAsync(enumerable, getKey, comparer: null, cancellationToken);
    ...
    public static ValueTask<T> FirstAsync<T>(this IAsyncEnumerable<T> enumerable, CancellationToken cancellationToken = default) => FirstAsync(enumerable, _ => true, cancellationToken);
    ...
    public static ValueTask<T?> FirstOrDefaultAsync<T>(this IAsyncEnumerable<T> enumerable, CancellationToken cancellationToken = default) => FirstOrDefaultAsync(enumerable, _ => true, cancellationToken);
    ...
    public static ValueTask<T> LastAsync<T>(this IAsyncEnumerable<T> enumerable, CancellationToken cancellationToken = default) => LastAsync(enumerable, _ => true, cancellationToken);
    ...
    public static ValueTask<T?> LastOrDefaultAsync<T>(this IAsyncEnumerable<T> enumerable, CancellationToken cancellationToken = default) => LastOrDefaultAsync(enumerable, _ => true, cancellationToken);
    ...
    public static IAsyncEnumerable<T> WhereNotNull<T>(this IAsyncEnumerable<T?> enumerable, CancellationToken cancellationToken = default) where T : class => enumerable.WhereAsync(item => item != null, cancellationToken)!;

    public static IAsyncEnumerable<string> WhereNotNullOrEmpty(this IAsyncEnumerable<string?> source, CancellationToken cancellationToken = default) => source.WhereAsync(item => !string.IsNullOrEmpty(item), cancellationToken)!;

    public static IAsyncEnumerable<string> WhereNotNullOrWhiteSpace(this IAsyncEnumerable<string?> source, CancellationToken cancellationToken = default) => source.WhereAsync(item => !string.IsNullOrWhiteSpace(item), cancellationToken)!;
}
