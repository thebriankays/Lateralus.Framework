namespace Lateralus.Framework.Text;

public static class Utf8Extensions
{
    public static SpanUtf8BytesRuneEnumerator EnumerateRunesFromUtf8(this ReadOnlySpan<byte> utf8Bytes) => new SpanUtf8BytesRuneEnumerator(utf8Bytes);
